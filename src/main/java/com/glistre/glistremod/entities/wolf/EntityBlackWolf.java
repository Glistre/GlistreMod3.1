...
public class EntityBlackWolf extends EntityWolf
{
    ...
    public EntityBlackWolf(World worldIn)
    {
        ...
        this.tasks.addTask(1,  new EntityAIAttackOnCollide(this, EntityGlistreWolf.class, 1.0D, true)); 
        ...
        if (this.isTamed())
        {
            if (itemstack != null)
            {
                if (itemstack.getItem() instanceof ItemFood)
                {
                    ...
                    if (itemfood.isWolfsFavoriteMeat() && this.dataWatcher.getWatchableObjectFloat(28) < 20.0F)
                    {

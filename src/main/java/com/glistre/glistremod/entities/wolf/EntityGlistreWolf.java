...
//        this.getAttributeMap().registerAttribute(SharedMonsterAttributes.attackDamage);
  ...
  //  	changed 18 to 27 can go to 31 better to use packets
        this.dataWatcher.updateObject(27, Float.valueOf(this.getHealth()));
    }

    protected void entityInit()
    {
        super.entityInit();
        this.dataWatcher.addObject(27, new Float(this.getHealth()));
        this.dataWatcher.addObject(29, new Byte((byte)0));
        this.dataWatcher.addObject(31, new Byte((byte)EnumDyeColor.RED.getMetadata()));
    }
    ...
    {
        return this.isAngry() ? "mob.wolf.growl" : (this.rand.nextInt(3) == 0 ? (this.isTamed() && this.dataWatcher.getWatchableObjectFloat(27) < 10.0F ? "mob.wolf.whine" : "mob.wolf.panting") : "mob.wolf.bark");
    }
        ...
        if (this.isTamed())
        {
            if (itemstack != null)
            {
                if (itemstack.getItem() instanceof ItemFood)
                {
                    ...
                    if (itemfood.isWolfsFavoriteMeat() && this.dataWatcher.getWatchableObjectFloat(27) < 20.0F)
                    {
    ...
    {
        return this.isAngry() ? 1.5393804F : (this.isTamed() ? (0.55F - (20.0F - this.dataWatcher.getWatchableObjectFloat(27)) * 0.02F) * (float)Math.PI : ((float)Math.PI / 5F));
    }
    ...
    {
        return EnumDyeColor.byDyeDamage(this.dataWatcher.getWatchableObjectByte(31) & 15);
    }

    public void setCollarColor(EnumDyeColor collarcolor)
    {
        this.dataWatcher.updateObject(31, Byte.valueOf((byte)(collarcolor.getDyeDamage() & 15)));
    }

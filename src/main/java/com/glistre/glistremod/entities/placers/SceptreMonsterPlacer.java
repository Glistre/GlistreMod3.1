...
public class SceptreMonsterPlacer extends ItemMonsterPlacer
{
...
//    private IIcon theIcon;
    ...
    protected String entityToSpawnName = "TobieSkellyGuardian";
    protected String entityToSpawnNameFull = "TobieSkellyGuardian";
//    protected String entityToSpawnName = "Tobie King";
//    protected String entityToSpawnNameFull = "Tobie King";
    protected EntityLiving entityToSpawn = null;

    public SceptreMonsterPlacer()
    {
        super();
        
    }
    
    public SceptreMonsterPlacer(String entityName, int primarycolor, 
          int secondarycolor)
    {

...
public class EntityTobieQueen extends EntityMob implements  IBossDisplayData, IRangedAttackMob
{
...
//    private static final String __OBFID = "CL_00001697";
 ...
 //     raise health from 15.0D to 705.0D
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(705.0D);

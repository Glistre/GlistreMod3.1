...
public class BlasterBow extends Item
{
 //   public static final String[] bowPullIconNameArray = new String[] {"pulling_0", "pulling_1", "pulling_2"};

 //   private IIcon[] iconArray;
    /**
     * private static final String __OBFID = "CL_00001777";" is a line generated during the forge decompile/deobfuscate process. 
         It is only needed in vanilla classes and might even cause errors if you put in your mod
     */    
...
@SideOnly(Side.CLIENT)
    ...
    public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
    {
        ...
        if (flag || p_77615_3_.inventory.hasItem(GlistreEntityRegistry.blaster_bolt_1))
        {

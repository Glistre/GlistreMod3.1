...
public class EntitySceptreBolt extends Entity implements IEntityAdditionalSpawnData
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
...
//    private static final String __OBFID = "CL_00001715";
    ...
    public EntitySceptreBolt(World worldIn)
    ...
    public EntitySceptreBolt(World worldIn, double x, double y, double z)
    {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
...
//        this.getYOffset();
    ...
    public EntitySceptreBolt(World worldIn, EntityLivingBase entityLiving, EntityLivingBase entityLIvingB, float float0, float float1)
    {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
...
//            this.getYOffset();
    ...
    public EntitySceptreBolt(World worldIn, EntityLivingBase entityliving, float f0)
    {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = entityliving;
...
//creates explosion on entity hit
 ...
 //                       this.playSound("random.explosion1", 2.1F, 4.2F);
                ...
                else
                {
                    ...
                    this.playSound("glistremod:laserblaster", 1.0F, 2.0F / (this.rand.nextFloat() * 0.2F + 0.9F));                    this.inGround = true;
                    this.arrowShake = 7;
 ...
 //               	this.worldObj.spawnParticle(EnumParticleTypes.CRIT, this.posX + this.motionX * (double)i / 4.0D, this.posY + this.motionY * (double)i / 4.0D, this.posZ + this.motionZ * (double)i / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ, new int[0]);
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (flag)
            {
                this.playSound("glistremod:enderblaster", 1.0F, ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);

...
public class EntityBlasterBolt extends Entity implements IEntityAdditionalSpawnData
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
...
//        this.getYOffset();
    ...
    public EntityBlasterBolt(World worldIn, EntityLivingBase entityLiving, EntityLivingBase entityLIvingB, float float0, float float1)
    {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
 ...
 //           this.getYOffset();
    ...
    public EntityBlasterBolt(World worldIn, EntityLivingBase entityliving, float f0)
    {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = entityliving;

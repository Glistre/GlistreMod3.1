...
public abstract class EntitySplashThrowable extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntitySplashThrowable(World worldIn)
    {
        super(worldIn);
 ...
 /*   @SideOnly(Side.CLIENT)
    ...
    public EntitySplashThrowable(World worldIn, EntityLivingBase entityLiving)
    {
        super(worldIn);
 ...
 //       this.getYOffset();
    ...
    public EntitySplashThrowable(World worldIn, double p_i1778_2_, double p_i1778_4_, double p_i1778_6_)
    {
        super(worldIn);
      ...
      if (this.throwableShake > 0)
        ...
        if (this.inGround)
        {
           BlockPos pos = new BlockPos(this.xTile, this.yTile, this.zTile);
            ...
            if (this.worldObj.getBlockState(pos).getBlock() == this.inTile)
            {
                ++this.ticksInGround;

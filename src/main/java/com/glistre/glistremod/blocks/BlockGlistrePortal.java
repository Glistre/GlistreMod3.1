...
public class BlockGlistrePortal extends BlockBreakable
{
    ...
    public BlockGlistrePortal(Material materialIn, boolean ignoreSimilarityIn)
    {
 ...
 /*   public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    {
        ...
        {
            entityIn.travelToDimension(Defaults.DIM_ID.GLISTRE);
   ...
   public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    ...
    if (entityIn.ridingEntity == null && entityIn.riddenByEntity == null && entityIn instanceof EntityPlayerMP) {
		...
		else if (player.dimension != Defaults.DIM_ID.GLISTRE) {
			player.timeUntilPortal = 10;
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        for (int i = 0; i < 4; ++i)
        {
			...
			if(worldIn.isRemote){     // or !worldObj.isRemote
	    		EntityFX particle = new EntityPortalFreonFX(worldIn, d0, d1, d2, d3, d4, d5); 
    ...
    public static class Size
        {
            ...
            protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
            {
                ...
                for (i = 0; i < 22; ++i)
                {
                    ...
                    if (!this.func_150857_a(this.world.getBlockState(blockpos1).getBlock()) || this.world.getBlockState(blockpos1.down()).getBlock() != BlockRegistry.silver_ore_1)
                    {
                        break;
                    }
                }
            ...
            protected int func_150858_a()
            {
                ...
                for (i = 0; i < this.field_150868_h; ++i)
                {
                    if (this.world.getBlockState(this.field_150861_f.offset(this.field_150866_c, i).up(this.field_150862_g)).getBlock() != BlockRegistry.silver_ore_1)
                    {
            ...
            {
    			return block.getMaterial() == Material.air || block == BlockRegistry.light_fire || block == BlockRegistry.light_portal;
            }

...
public class BlockGlistreFire extends BlockFire
{
   ...
   public BlockGlistreFire()
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
        ...
        if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.down()) && !((BlockFire) BlockRegistry.light_fire).canCatchFire(worldIn, pos.down(), EnumFacing.UP))
        {
    ...
    {
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.planks, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.double_wooden_slab, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.wooden_slab, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.oak_fence_gate, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.spruce_fence_gate, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.birch_fence_gate, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.jungle_fence_gate, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.dark_oak_fence_gate, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.acacia_fence_gate, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.oak_fence, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.spruce_fence, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.birch_fence, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.jungle_fence, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.dark_oak_fence, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.acacia_fence, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.oak_stairs, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.birch_stairs, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.spruce_stairs, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.jungle_stairs, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.log, 5, 5);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.log2, 5, 5);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.leaves, 30, 60);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.leaves2, 30, 60);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.bookshelf, 30, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.tnt, 15, 100);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.tallgrass, 60, 100);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.double_plant, 60, 100);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.yellow_flower, 60, 100);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.red_flower, 60, 100);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.deadbush, 60, 100);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.wool, 30, 60);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.vine, 15, 100);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.coal_block, 5, 5);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.hay_block, 60, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.carpet, 60, 20);
    }
    ...
    {
        if (worldIn.provider.getDimensionId() > 0 || !((BlockGlistrePortal) BlockRegistry.light_portal).func_176548_d(worldIn, pos))
        {
            if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.down()) && !this.canNeighborCatchFire(worldIn, pos))
            {
                worldIn.setBlockToAir(pos);
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.down()) && !((BlockFire) BlockRegistry.light_fire).canCatchFire(worldIn, pos.down(), EnumFacing.UP))
        {
            if (((BlockFire) BlockRegistry.light_fire).canCatchFire(worldIn, pos.west(), EnumFacing.EAST))
            {
                for (i = 0; i < 2; ++i)
                {
            ...
            if (((BlockFire) BlockRegistry.light_fire).canCatchFire(worldIn, pos.east(), EnumFacing.WEST))
            {
                for (i = 0; i < 2; ++i)
                {
            ...
            if (((BlockFire) BlockRegistry.light_fire).canCatchFire(worldIn, pos.north(), EnumFacing.SOUTH))
            {
                for (i = 0; i < 2; ++i)
                {
            ...
            if (((BlockFire) BlockRegistry.light_fire).canCatchFire(worldIn, pos.up(), EnumFacing.DOWN))
            {
                for (i = 0; i < 2; ++i)
                {
                    d0 = (double)pos.getX() + rand.nextDouble();

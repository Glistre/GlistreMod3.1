...
import com.glistre.glistremod.dimension.TeleporterTobyKing;
...
public class BlockTobyKingPortal extends BlockBreakable
{
    ...
    public BlockTobyKingPortal(Material materialIn, boolean ignoreSimilarityIn) {
 ...
 // HERE IS THE LIGHT PORTAL METHOD: func_150000_e replaces tryToCreatePortal became getPortalSize in 1.7.10 now called func_176548_d
    public boolean func_176548_d(World worldIn, BlockPos blockPos)
    {
        ...
        if (size.func_150860_b() && size.field_150864_e == 0)
        {
        	...
        	(size1.func_150860_b() && size1.field_150864_e == 0)
            {
                size1.func_150859_c();
                return true;
            }
...
/*    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    ...
    if (entityIn.ridingEntity == null && entityIn.riddenByEntity == null && entityIn instanceof EntityPlayerMP) {
		...
		else if (player.dimension != Defaults.DIM_ID.FREON) {
			player.timeUntilPortal = 10;
			player.mcServer.getConfigurationManager().transferPlayerToDimension(player, Defaults.DIM_ID.FREON, new TeleporterTobyKing(server.worldServerForDimension(Defaults.DIM_ID.FREON)));
			entityIn.getPortalCooldown();
			}
		else {
			player.timeUntilPortal = 10;
			player.mcServer.getConfigurationManager().transferPlayerToDimension(player, 0, new TeleporterTobyKing(server.worldServerForDimension(0)));
		}
	}
}
    ...
    public static class Size
        {
            ...
            protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
            {
                ...
                for (i = 0; i < 22; ++i)
                {
                    ...
                    if (!this.func_150857_a(this.world.getBlockState(blockpos1).getBlock()) || this.world.getBlockState(blockpos1.down()).getBlock() != BlockRegistry.silver_block_1)
                    {
                        break;
                    }
                }
            ...
            protected int func_150858_a()
            {
                ...
                for (i = 0; i < this.field_150868_h; ++i)
                {
                    if (this.world.getBlockState(this.field_150861_f.offset(this.field_150866_c, i).up(this.field_150862_g)).getBlock() != BlockRegistry.silver_block_1)
                    {
            ...
            {
    			return block.getMaterial() == Material.air || block == BlockRegistry.light_toby_king_fire || block == BlockRegistry.light_toby_king_portal;
            }

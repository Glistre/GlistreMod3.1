...
public class TileEntityGlistreChest extends TileEntityChest
{
 ...
 //   private static final String __OBFID = "CL_00000346";
    ...
    public TileEntityGlistreChest(int chestType)
    {
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        if (compound.hasKey("Glistre Chest", 8))
        {
            this.customName = compound.getString("Glistre Chest");
        }
    ...
    public void writeToNBT(NBTTagCompound compound)
    {
        ...
        {
            compound.setString("Glistre Chest", this.customName);
        }
    }
